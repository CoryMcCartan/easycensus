...
age and race. `easycensus` provides the
[`cens_find_dec()`](http://corymccartan.com/easycensus/reference/cens_find.md)
function to help you locate exactly which decennial census table to use
...
you need to do to get your data is to call
...
unneeded `sex` variable. You can either use
[`group_by()`](https://dplyr.tidyverse.org/reference/group_by.html) and
[`summarize()`](https://dplyr.tidyverse.org/reference/summarise.html) as
usual, or you can use the
[`cens_margin_to()`](http://corymccartan.com/easycensus/reference/cens_margin_to.md)
function in `easycensus`. This has the added advantage of automatically
