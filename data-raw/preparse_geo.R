    ...
    dplyr::pull()
{
    ...
    short[
        short == "american_indian_area_alaska_native_area_reservation_or_statistical_entity_only"
    ] = "aian_reserve_stat"
    short[
        short == "american_indian_area_alaska_native_area_reservation_or_statistical_entity_only_part"
    ...
    short[
        short == "american_indian_area_off_reservation_trust_land_only_hawaiian_home_land"
    ] = "ai_off_reserve_trust"
    short[
        short == "american_indian_area_off_reservation_trust_land_only_hawaiian_home_land_part"
